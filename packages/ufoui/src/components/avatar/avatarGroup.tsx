...
import { BorderColor, cn, ElementBorder, ElementShape, ElementSize } from '../../utils';
...
export const AvatarGroup = forwardRef<HTMLDivElement, AvatarGroupProps>(
    ({ children, max, overlap = 8, size, shape, border, borderColor, overflow, className, ...rest }, ref) => {
        const avatars: ReactElement<AvatarProps>[] = Children.toArray(children).filter(isAvatar);
        ...
        const classes = cn('uui-avatar-group', className);
        return (
