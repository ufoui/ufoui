 ...
 * @internal
 */
export function isDivider(el: React.ReactNode): el is React.ReactElement<DividerProps> {
    return isValidElement(el) && typeof el.type !== 'string' && !!(el.type as DividerMarker)[IS_DIVIDER];
}
