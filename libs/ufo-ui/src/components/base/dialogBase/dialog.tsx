...
const resolveAnimation = (animation: DialogAnimation, type: DialogType): MotionAnimation | 'none' => {
...
export const Dialog = ({
    ...
    useEffect(() => {
        ...
        const target: HTMLElement | null = focusables.length > 0 ? focusables[0] : dialogRef.current;
    ...
    const controlStyle = {
        '--uui-reverse': reverse,
        '--uui-duration': reverse === 'reverse' ? String(duration * 0.67) + 'ms' : String(duration) + 'ms',
    } as React.CSSProperties;
