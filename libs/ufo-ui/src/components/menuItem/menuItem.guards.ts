 ...
 * @internal
 */
export function isMenuItem(el: React.ReactNode): el is ReactElement<MenuItemProps & MenuItemInternalProps> {
    return isValidElement(el) && typeof el.type !== 'string' && !!(el.type as MenuItemMarker)[IS_MENU_ITEM];
}
