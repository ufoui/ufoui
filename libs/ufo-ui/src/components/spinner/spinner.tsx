...
export function Spinner({ variant = 'circular', inline, className }: SpinnerProps) {
    const classes = ['uui-spinner', `uui-spinner-${variant}`, inline && 'uui-spinner-inline', className]
        .filter(Boolean)
        .join(' ');
    ...
    if (variant === 'circular') {
        return (
            <svg aria-hidden="true" className={classes} viewBox="22 22 44 44">
                <circle className="uui-spinner-circle" cx="44" cy="44" fill="none" r="19.8" strokeWidth="4.6" />
            </svg>
        );
    }
    ...
    if (variant === 'bars2') {
        return (
            <svg className="uui-bars-spinner" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
    ...
    if (variant === 'orbit') {
        return (
            <svg className="uui-orbit-spinner" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
    ...
    if (variant === 'arc') {
        return (
            <svg className="uui-ring-spinner" viewBox="0 0 56 56" xmlns="http://www.w3.org/2000/svg">
                <circle cx="28" cy="28" fill="none" opacity="0.25" r="22" stroke="currentColor" strokeWidth="8" />
    ...
    return (
        <svg className="uui-dots2-spinner" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
