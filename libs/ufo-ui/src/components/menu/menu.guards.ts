...
import { MenuInternalProps, MenuProps } from '@ufoui/core';
 ...
 * @internal
 */
export function isMenu(el: React.ReactNode): el is ReactElement<MenuProps & MenuInternalProps> {
    return isValidElement(el) && typeof el.type !== 'string' && !!(el.type as MenuMarker)[IS_MENU];
}
