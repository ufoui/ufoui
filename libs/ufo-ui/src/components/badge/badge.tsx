...
import { BorderColor, ControlStyle, getBorderColor, SemanticColor } from '../../utils/color';
...
export const Badge = (props: BadgeProps) => {
    ...
    const finalFont = font ?? (size === 'extraLarge' || size === 'large' ? 'labelMedium' : 'labelSmall');
    ...
    const control = (
        <span aria-label={ariaLabel} className={controlClass} style={controlStyle.get()}>
