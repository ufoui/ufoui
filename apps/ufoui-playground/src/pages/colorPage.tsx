...
const ColorPage = () => {
  ...
  const { textBaseColor, borderBaseColor, bgBaseColor, textOnBackground } =
    getFixedColorClasses();
  return (
    <Grid className="EDEK grid-cols-2 gap-x-2">
      ...
      {['light', 'dark'].map((scheme) => (
        <div className={`flex justify-between ${scheme}`} key={scheme}>
          ...
          >
            ...
            <div>
              {lcTheme[scheme].surfacevariant} /{' '}
              {lcTheme[scheme].onsurfacevariant}
            </div>
          </div>
          <div
            className="flex grow flex-col p-2"
      ...
      <div className="col-span-2 pt-2 font-bold capitalize">
        Surface Container
      </div>
      {['light', 'dark'].map((scheme) => (
        <div className={`flex justify-between ${scheme}`} key={scheme}>
          ...
          >
            ...
            <div>
              {lcTheme[scheme].surfacecontainerlowest} /{' '}
              {lcTheme[scheme].onsurface}
            </div>
          </div>
          <div
            className="flex grow flex-col p-2"
          ...
          >
            ...
            <div>
              {lcTheme[scheme].surfacecontainerlow} /{' '}
              {lcTheme[scheme].onsurface}
            </div>
          </div>
          <div
          ...
          >
            ...
            <div>
              {lcTheme[scheme].surfacecontainerhigh} /{' '}
              {lcTheme[scheme].onsurface}
            </div>
          </div>
          <div
          ...
          >
            ...
            <div>
              {lcTheme[scheme].surfacecontainerhighest} /{' '}
              {lcTheme[scheme].onsurface}
            </div>
          </div>
        </div>
      ...
      {['light', 'dark'].map((scheme) => (
        <div className={`flex justify-between ${scheme}`} key={scheme}>
          ...
          >
            ...
            <div>
              {lcTheme[scheme].inversesurface} /{' '}
              {lcTheme[scheme].inverseonsurface}
            </div>
          </div>
          <div
            className="flex grow flex-col p-2"
      ...
      {['light', 'dark'].map((scheme) => (
        <div className={`flex justify-between ${scheme}`} key={scheme}>
          ...
          >
            ...
            <div>
              {lcTheme[scheme].inverseprimary} /{' '}
              {lcTheme[scheme].onprimarycontainer}
            </div>
          </div>
          <div
            className="flex grow flex-col p-2"
