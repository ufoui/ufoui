        ...
        <Article direction="row" wf>
            <Content gap={20} grow>
                ...
                <Section gap={20}>
                    <P>Image avatars</P>
                    <Flex gap={16} wrap>
                        <Avatar {...shared} name="John Smith" src="https://i.pravatar.cc/100?img=1" />
                        <Avatar {...shared} name="Anna Kowalska" src="https://i.pravatar.cc/100?img=2" />
                ...
                <Section gap={20}>
                    ...
                    <Flex gap={16}>
                        <Avatar {...shared}>
                            <Grid color="inverseSurface" hf placeItems="center" wf>
                                👽
                            </Grid>
                        </Avatar>
                    </Flex>
                    ...
                    <Section gap={20}>
                        ...
                        <Flex gap={16} wrap>
                            <AvatarGroup overlap={8}>
                                <Avatar name="John Smith" src="https://i.pravatar.cc/100?img=1" />
                                <Avatar name="Anna Kowalska" src="https://i.pravatar.cc/100?img=2" />
                        ...
                        <Flex gap={16} wrap>
                            ...
                            <AvatarGroup
                                max={3}
                                overflow={count => <Avatar color="surfaceVariant">+{count}</Avatar>}
                                overlap={8}>
                                <Avatar name="John Smith" />
                                <Avatar name="Anna Kowalska" />
                                <Avatar name="Jean Claude" />
                        ...
                        <Flex gap={16} wrap>
                            <AvatarGroup border={2} borderColor="surface" overlap={8} shape="round" size="small">
