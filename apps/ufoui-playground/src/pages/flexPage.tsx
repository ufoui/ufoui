    ...
    return (
        <div className="flex">
            <div className="grid grid-cols-[max-content_1fr] items-center gap-x-5 gap-y-5">
                ...
                <div>Size</div>
                <div className="flex items-center gap-4">
                    <Button color="primary" filled icon={<MdAdd />} label="Label" outlined {...shared} size="small" />
                    <Button color="primary" filled icon={<MdAdd />} label="Label" outlined {...shared} size="medium" />
                    <Button color="primary" filled icon={<MdAdd />} label="Label" outlined {...shared} size="large" />
                </div>
            </div>
