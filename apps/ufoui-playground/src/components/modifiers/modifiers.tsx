            ...
            onChange={(e) => {
              onChange({
                ...
                textColor:
                  e.target.value === ''
                    ? undefined
                    : (e.target.value as SurfaceColor),
              });
            }}
            value={textColor ?? ''}
          >
            ...
            onChange={(e) => {
              onChange({
                ...
                border:
                  e.target.value === ''
                    ? undefined
                    : (+e.target.value as ElementBorder),
              });
            }}
            value={border ?? ''}
          >
            ...
            onChange={(e) => {
              onChange({
                ...
                density:
                  e.target.value === ''
                    ? undefined
                    : (e.target.value as ElementDensity),
              });
            }}
            value={density ?? ''}
          >
            ...
            onChange={(e) => {
              onChange({
                ...
                textPlacement:
                  e.target.value === ''
                    ? undefined
                    : (e.target.value as ElementTextPlacement),
              });
            }}
            value={textPlacement ?? ''}
          >
