...
import { MdCake, MdDoNotDisturb, MdOutlineFavorite as MdFavorite, MdFavoriteBorder } from 'react-icons/md';
            ...
            <Content gap={20} grow px={20}>
                <Section shape="rounded">
                    <RadioGroup
                        ...
                        <Radio disabled {...shared} checked label="Disabled checked" value="disabled2" />
                    </RadioGroup>
                </Section>
                <Section>
                    <RadioGroup
                        ...
                        <Radio {...shared} color="info" defaultChecked label="Info" value="info" />
                        <Radio {...shared} color="success" defaultChecked label="Success" value="success" />
                        <Radio {...shared} color="warning" defaultChecked label="Warning" value="warning" />
                        <Radio {...shared} color="error" defaultChecked label="Error" value="error" />
                    </RadioGroup>
                </Section>
                <Section>
                ...
                <Section>
                    <RadioGroup
                        ...
                        <Radio {...shared} defaultChecked label="Large" size="large" value="large" />
                        <Radio {...shared} defaultChecked label="ExtraLarge" size="extraLarge" value="extraLarge" />
                    </RadioGroup>
                </Section>
                ...
                <Section>
                    <RadioGroup disabled={disabled ?? undefined} gap={16} label="Custom icons" name="icons" row wrap>
                        ...
                        <Radio
                            ...
                            value="4"
                        />
                        <Radio {...shared} defaultChecked icon={<MdFavorite />} label="1 icon" value="5" />
                        <Radio {...shared} filled={false} icon={<MdFavorite />} label="1 icon/-Filled" value="6" />
                        <Radio {...shared} label="Unchecked Only" uncheckedIcon={<MdFavorite />} value="7" />
                    </RadioGroup>
                </Section>
