...
import { Button, Dialog, DialogActions, DialogContent, DialogTitle, DialogType, Section } from '@ufoui/core';
...
export default function DialogPage() {
    ...
    const [dialogType, setDialogType] = useState<(typeof dialogTypes)[number]>('basic');
